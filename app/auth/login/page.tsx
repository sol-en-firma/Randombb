        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 space-y-6">
          ...
          <form action={signIn} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/auth/reset-password" className="text-xs text-orange-600 font-medium hover:text-orange-700">
          ...
          <div className="text-center">
            <p className="text-gray-600 text-sm">
              ¿No tienes cuenta?{' '}
              <Link href="/auth/sign-up" className="text-orange-600 font-semibold hover:text-orange-700">
                Crear cuenta
              </Link>
            </p>
          </div>
